...
describe('WunderDistributor', () => {
  ...
  describe('Create New Event', () => {
    ...
    //     expect(await distributor.connect(moritz).placeBet(0, [0], [[4, 2]]))
    ...
    //     expect(await distributor.connect(moritz).placeBet(1, [1], [[4, 2]]))
    //       .to.emit(distributor, 'NewParticipant')
    //       .withArgs(0, 0, moritz.address);
    //   });
    ...
    //       [0, [0], distributor.address, [[4, 2]]],
    //       false
    //     );
    //     expect(
    //       await distributor.placeBetForUser(
    //         0,
    //         [0],
    //         [[4, 2]],
    //         moritz.address,
    ...
    //         );
    //         expect(await govToken.balanceOf(max.address)).to.equal(
    //           maxBalance.sub(tournamentStake).add(priceMoney.mul(5).div(10).div(2))
    //         );
    //       });
    //     });
    //   });
