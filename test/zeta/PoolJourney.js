...
describe('POOL JOURNEY', () => {
  ...
  describe('Moritz creates a new Pool', () => {
    ...
    beforeEach(async () => {
      ...
      pool = await ethers.getContractAt('WunderPoolZeta', poolAddress, moritz);
    ...
    describe('Moritz invites his friends to join', () => {
      ...
      describe('Users Join the Pool', () => {
        ...
        describe('Users trade Tokens', () => {
          ...
          beforeEach(async () => {
            const WS = await ethers.getContractFactory('WunderSwapperZeta');
